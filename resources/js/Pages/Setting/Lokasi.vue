...
// array
const columns = [
    {label: 'Lokasi', field: 'name', search: true, sortable: true, width: 'auto'},
    {label: 'Alias', field: 'alias', search: true, sortable: true, width: 'auto'},
...
const addFunction = () => {
    ...
    popModal.value.title = 'Tambah Lokasi'
...
const editFunction = (val) => {
    ...
    popModal.value.status = true
    popModal.value.title = 'Ubah Lokasi'
    isLoading.value = false
}
...
const validation = () => {
    ...
    if (Model.alias === '') {
        alerts.value.status = true
        alerts.value.message = 'Alias Tidak Boleh Kosong'
        alerts.value.type = 'danger'
        return false;
    }
    save();
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                >
                    <template #table-row="props">
                        ...
                        <span v-if="props.column.field === 'alias'">
                                  <span class="uppercase">{{ props.row.alias }}</span>
                                </span>
