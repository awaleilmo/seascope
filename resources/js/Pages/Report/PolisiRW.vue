...
import PolisiRwModel from "@/Models/PolisiRw.model.js";
...
const columns = [
    ...
    {label: 'Polda', field: 'polda.name', search: true, sortable: true, width: '150px'},
    ...
    {label: 'Sambang', field: 'sambang', search: true, sortable: true, width: '250px'},
    {label: 'Pemecahan Masalah Sosial', field: 'pemecahaan', search: true, sortable: true, width: '250px'},
    {label: 'Laporan Informasi', field: 'informasi', search: true, sortable: true, width: '250px'},
    {label: 'Penanganan Perkara Ringan', field: 'penanganan', search: true, sortable: true, width: '250px'},
]
...
const addFunction = async () => {
    ...
    popModal.value.title = 'Tambah Data Laporan Polisi RW'
...
const editFunction = async (val) => {
    ...
    Model.personil_sat = JSON.parse(val.personil_satu)
    Model.sambang = val.sambang
    Model.pemecahaan = val.pemecahaan
    Model.informasi = val.informasi
    Model.penanganan = val.penanganan
    Model.keterangan = val.keterangan
    Model.foto = val.foto
    Model.tanggal = val.tanggal
    Model.waktu = val.waktu
    popModal.value.status = true
    popModal.value.title = 'Ubah Data Laporan Polisi RW'
    isLoading.value = false
}
...
<template>
    ...
    <AuthenticatedLayout :props-loading="isLoading">
                        ...
                        <template #table-row="props">
                                <span v-if="props.column.field === 'jumlah'">
                                  <span class="capitalize"
                                        v-html=" formatPersonil(props.row.personil_jml)"/>
                                </span>
            ...
            <div class="relative">
                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="rounded border px-2 py-3">
                                ...
                                >
                                    ...
                                    <TextInput
                                        type="text"
                                        class="mt-1 hidden w-full capitalize"
                        ...
                        <hr class="mt-4"/>
                        <div class="mt-4">
                            <InputLabel value="Pemecahan Masalah Sosial"/>
                            <TextInputArea
                                type="number"
                                class="mt-1 block w-full capitalize"
                                v-model="Model.pemecahaan"
                                placeholder="Pemecahan Masalah Sosial ..."
                            />
                        </div>
                        <hr class="mt-4"/>
                        <div class="mt-4">
                            <InputLabel value="Laporan Informasi"/>
                            <TextInputArea
                                class="mt-1 block w-full capitalize"
                                v-model="Model.informasi"
                                placeholder="Laporan Informasi ..."
                            />
                        </div>
                        <hr class="mt-4"/>
                        <div class="mt-4">
                            <InputLabel value="Penanganan Perkara Ringan"/>
                            <TextInputArea
                                class="mt-1 block w-full capitalize"
                                v-model="Model.penanganan"
                                placeholder="Penanganan Perkara Ringan ..."
                            />
                        </div>
                        <hr class="mt-4"/>
                        <div class="mt-4">
        ...
        <PrintPopUp
            ...
            title="Print Laporan Polisi RW"
            urlPrint="/api/report/rw/download"
        />
