...
import SentuhanModel from "@/Models/Sentuhan.model.js";
...
const startup = async () => {
    ...
    let rawDT = await Model.getSentuhanPage(`data=${encode}`)
...
const addFunction = async () => {
    ...
    popModal.value.title = 'Tambah Data Sambang Nusa Presisi Sentuhan'
...
const editFunction = async (val) => {
    ...
    popModal.value.status = true
    popModal.value.title = 'Ubah Data Sambang Nusa Presisi Sentuhan'
    isLoading.value = false
}
