...
import BinaanModel from "@/Models/Binaan.model.js";
...
const startup = async () => {
    ...
    let rawDT = await Model.getBinaanPage(`data=${encode}`)
...
const addFunction = async () => {
    ...
    popModal.value.title = 'Tambah Data Sambang Nusa Presisi Binaan'
...
const editFunction = async (val) => {
    ...
    popModal.value.status = true
    popModal.value.title = 'Ubah Data Sambang Nusa Presisi Binaan'
    isLoading.value = false
}
            ...
            >
                <template #table-row="props">
                    ...
                    <span v-if="props.column.field === 'tanggal'">
                                              <span class="capitalize"> {{ props.row.tanggal }}</span>
                                            </span>
        ...
        <div class="relative">
            ...
            <div class="relative bg-white rounded-lg shadow">
                ...
                <div class="p-6">
                    ...
                    <hr class="mt-4"/>
                    <div class="mt-4">
                        <InputLabel value="Route / Jarak (  Nautical Mile )"/>
                        <TextInput
                            type="number"
                            class="mt-1 block w-full capitalize"
                            v-model="Model.jarak"
                            placeholder="Jarak ( NM )"
                        />
                    </div>
                    <hr class="mt-4"/>
                    <div class="mt-4">
